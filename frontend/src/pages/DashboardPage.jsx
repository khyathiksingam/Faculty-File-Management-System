  ...
  return (
    <div className="space-y-6 text-left">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {isAdmin ? (
          <>
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">Active teaching staff</p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">With assigned HODs</p>
            </div>

            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">College Files</span>
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">Total documents stored</p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">of 20 GB allocated</p>
            </div>
          </>
        ) : isHOD ? (
          <>
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Dept Faculty</span>
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-50 text-blue-600">
                  <Users className="h-4 w-4" />
                </div>
              </div>
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">Members in {user?.department_code}</p>
            </div>

            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Dept Documents</span>
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600">
                  <Files className="h-4 w-4" />
                </div>
              </div>
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">Academic & exam files</p>
            </div>

            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Dept Storage</span>
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-50 text-amber-600">
                  <HardDrive className="h-4 w-4" />
                </div>
              </div>
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">Quota usage</p>
            </div>

            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Shared Files</span>
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-purple-50 text-purple-600">
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">Accessible files</p>
            </div>
          </>
        ) : (
          <>
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">My Files</span>
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-50 text-blue-600">
                  <Files className="h-4 w-4" />
                </div>
              </div>
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">Uploaded documents</p>
            </div>

            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">My Storage</span>
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-50 text-amber-600">
                  <HardDrive className="h-4 w-4" />
                </div>
              </div>
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">Total used</p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">Organized categories</p>
            </div>

            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs transition hover:shadow-md hover:border-indigo-200">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Starred</span>
              ...
              <p className="mt-1 text-[11px] font-medium text-slate-400">Priority documents</p>
            </div>
          </>
        )}
      </div>
            ...
            {recentFiles.length === 0 ? (
              ...
              recentFiles.slice(0, 5).map((file) => (
                <div
                  ...
                  className="flex cursor-pointer items-center justify-between rounded-xl p-2.5 transition hover:bg-slate-50 border border-transparent hover:border-slate-100"
                >
                ...
                <div key={log.id} className="flex items-start gap-2.5 text-xs text-left">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="font-medium text-slate-700">
                      <span className="font-bold text-slate-900">{log.user_name || 'User'}</span> {log.action.toLowerCase()}
                    </p>
